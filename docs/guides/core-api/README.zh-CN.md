...
当前源码版本是 Core API **1.85**。生成的 TypeScript 契约位于 [`src/core-api/generated/core-api.ts`](../../../src/core-api/generated/core-api.ts)，Rust 公开类型与稳定 command 声明从 [`crates/core-api/src/lib.rs`](../../../crates/core-api/src/lib.rs) 开始，production command 注册在 [`src-tauri/src/lib.rs`](../../../src-tauri/src/lib.rs)。本检查点有 48 个公开 Core 模块、857 个导出的 TypeScript 声明、210 个稳定 `COMMAND_*` 名称和 276 个已注册 Tauri handler。后者可包含只用于 Wry 或未导出的应用内部接线，因此两个目录必须分开阅读。
