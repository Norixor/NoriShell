...
`norishell-core-api` has 48 re-exported modules. The complete machine-derived list of all 857 TypeScript declarations is [types.generated.md](types.generated.md); it is the index to use for exact type spelling and scope.
