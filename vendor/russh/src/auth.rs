...
impl fmt::Debug for Method {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        let kind = match self {
            ...
            Self::PublicKey { .. } => "PublicKey([REDACTED])",
            Self::OpenSshCertificate { .. } => "OpenSshCertificate([REDACTED])",
            Self::FuturePublicKey { .. } => "FuturePublicKey",
            Self::FutureCertificate { .. } => "FutureCertificate",
            Self::KeyboardInteractive { .. } => "KeyboardInteractive([REDACTED])",
            Self::GssapiWithMic { .. } => "GssapiWithMic([REDACTED])",
        };
