...
impl RdpSpecificCode {
    pub fn description(&self) -> &str {
        match self {
            ...
            Self::ControlPduSequence => {
                "An out-of-sequence Slow-Path Non-Data PDU has been received"
            }
            Self::InvalidControlPduAction => {
                "A Control PDU has been received with an invalid action field"
            }
            ...
            Self::CreateUserDataFailed => {
                "The server failed to construct the GCC Conference Create Response user data"
            }
            Self::ConnectFailed => {
            ...
            Self::PersistentKeyPduBadLength => {
                "There is not enough data to process a Persistent Key List PDU"
            }
            ...
            Self::DngCacheErrorPduBadLength => {
                "There is not enough data to process a DrawNineGrid Cache Error PDU"
            }
            Self::GdiPlusPduBadLength => "There is not enough data to process a GDI+ Error PDU",
            Self::SecurityDataTooShort2 => {
                "There is not enough data to read a Basic Security Header"
            }
            ...
            Self::SecurityDataTooShort23 => {
                "There is not enough data to read the Client Info PDU Data"
            }
            Self::BadMonitorData => {
            ...
            Self::GraphicsSubsystemResetFailed => {
            ...
            Self::VcDecodingError => {
                "An error occurred when processing dynamic virtual channel data"
            }
            ...
            Self::InvalidMonitorCount => {
                "The monitorCount field in the Client Monitor Data is too large"
            }
