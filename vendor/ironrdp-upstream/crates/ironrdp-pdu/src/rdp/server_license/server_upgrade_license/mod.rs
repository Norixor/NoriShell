...
use super::{
    BLOB_LENGTH_SIZE, BLOB_TYPE_SIZE, BlobHeader, BlobType, LicenseEncryptionData, LicenseHeader,
    MAC_SIZE, PreambleType, ServerLicenseError, UTF8_NULL_TERMINATOR_SIZE,
...
impl Encode for LicenseInformation {
    fn encode(&self, dst: &mut WriteCursor<'_>) -> EncodeResult<()> {
        ...
        dst.write_u32(
            cast_length!("scopeLen", self.scope.len() + UTF8_NULL_TERMINATOR_SIZE, in: dst)?,
        );
