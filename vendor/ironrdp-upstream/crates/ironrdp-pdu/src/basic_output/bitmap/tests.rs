...
const BITMAP_BUFFER: [u8; 114] = [
    ...
    0x0e, 0x82, 0x45, 0x29, 0x7a, 0xce, 0xd5, 0x82, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 0x80, 0x0e,
    0x45, 0x29, 0x9e, 0xf7, 0xff, 0xff, 0x9e, 0xf7, 0x45, 0x29, 0x21, 0x00, 0x55, 0xad, 0x10, 0x10,
    0xa8, 0xd8, 0x60, 0x12,
];
...
fn to_buffer_bitmap_data_serializes_correctly() {
    ...
    encode(&*BITMAP, buffer.as_mut_slice()).unwrap();
